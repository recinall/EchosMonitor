...
* The **Spectrogram** dock
  (:class:`~seedlink_dashboard.gui.widgets.spectrogram_dock.SpectrogramDock`)
...
from seedlink_dashboard.gui.widgets.live_stack import _STATE_COLORS, LiveStack
from seedlink_dashboard.gui.widgets.trace_plot import TracePlot
