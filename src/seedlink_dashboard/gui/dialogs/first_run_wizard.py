...
(see :mod:`seedlink_dashboard.core.firstrun`). Three short pages:
...
from seedlink_dashboard.gui.dialogs.device_dialog import DeviceForm
...
class _WelcomePage(QWizardPage):
    ...
    def __init__(self, info_worker: InfoWorker, parent: QWidget | None = None) -> None:
        ...
        self.setTitle("Welcome to SeedLink Dashboard")
        self.setSubTitle("Choose how you'd like to get started.")

        layout = QVBoxLayout(self)
        blurb = QLabel(
            "SeedLink Dashboard streams real-time seismic data from one or more "
...
class FirstRunWizard(QWizard):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(parent)
        self.setWindowTitle("SeedLink Dashboard — First Run")
        self.setModal(True)
