...
from seedlink_dashboard.core.collisions import NslcCollision, find_nslc_collisions
from seedlink_dashboard.core.exceptions import ConfigError, ResponseError
    ...
    * DSP chain summary label + disabled "Edit chain..." button
    ...
    def validate_response_metadata(self) -> str | None:
        ...
        if meta.path is None:
            return None
        from seedlink_dashboard.core.response import load_inventory
    ...
    def _on_edit_chain_clicked(self) -> None:
        ...
        from seedlink_dashboard.gui.dialogs.chain_editor_dialog import (
            ChainEditorDialog,
        )
