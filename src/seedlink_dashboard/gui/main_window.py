...
from seedlink_dashboard.core.deconvolution_worker import DeconvolutionWorker
...
from seedlink_dashboard.gui.widgets.detection_table import DetectionTable
from seedlink_dashboard.gui.widgets.device_panel import DevicePanel
from seedlink_dashboard.gui.widgets.dock_title_bar import DockTitleBar
from seedlink_dashboard.gui.widgets.hvsr_widget import HvsrWidget
from seedlink_dashboard.gui.widgets.live_stack import LiveStack
from seedlink_dashboard.gui.widgets.live_tabs import LiveTabs
from seedlink_dashboard.gui.widgets.psd_widget import PsdWidget
from seedlink_dashboard.gui.widgets.spectrogram_dock import SpectrogramDock
from seedlink_dashboard.gui.widgets.station_browser import StationBrowser
from seedlink_dashboard.utils.docs import find_manual_tests
...
class MainWindow(QMainWindow):
    ...
    * **Esc** — exit focus mode (only active while focused).
    ...
    :data:`~seedlink_dashboard.gui.dialogs.shortcuts_dialog.SHORTCUT_GROUPS`.
    """
    ...
    def __init__(
        ...
        self.setWindowTitle("SeedLink Dashboard")
    ...
    def _build_menubar(self) -> None:
        ...
        about_action = QAction("&About SeedLink Dashboard", self)
    ...
    def _on_show_about(self) -> None:
        QMessageBox.about(
            self,
            "About SeedLink Dashboard",
            f"<b>SeedLink Dashboard</b> v{__version__}<br>"
