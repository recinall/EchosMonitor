...
frozen :class:`~seedlink_dashboard.core.hvsr.HvsrResult`, this module writes:
...
if TYPE_CHECKING:
    ...
    from seedlink_dashboard.core.hvsr import HvsrResult
...
def result_to_dict(result: HvsrResult, ctx: ReportContext) -> dict[str, object]:
    ...
    return {
        "schema": "seedlink_dashboard.hvsr/1",
...
def _pdf_page_numbers(plt: Any, pdf: Any, res: HvsrResult, ctx: ReportContext) -> None:
    ...
    fig.text(
        0.07,
        0.03,
        f"Generated {ctx.generated_at} by SeedLink Dashboard v{APP_VERSION}",
        ha="left",
        va="bottom",
        family="monospace",
        fontsize=8,
