...
run off the GUI thread, but — unlike the Welch :class:`~seedlink_dashboard.
...
:meth:`~seedlink_dashboard.core.response.ResponseRemover.to_physical`
...
from seedlink_dashboard.core.exceptions import ResponseError
