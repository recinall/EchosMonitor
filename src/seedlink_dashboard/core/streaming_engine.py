...
key is :func:`seedlink_dashboard.core.models.device_stream_key`
...
from seedlink_dashboard.core.collisions import find_nslc_collisions
from seedlink_dashboard.core.config_diff import diff_devices
from seedlink_dashboard.core.dsp_router import _DspRouter
from seedlink_dashboard.core.models import (
    DEVICE_KEY_SEP,
    ConnState,
    Detection,
    DeviceStatus,
...
from seedlink_dashboard.core.psd_worker import PsdWorker
from seedlink_dashboard.core.ring_buffer import RingBuffer
from seedlink_dashboard.core.seedlink_worker import SeedLinkWorker
...
if TYPE_CHECKING:
    ...
    from seedlink_dashboard.config import DeviceConfig, DspStageConfig, RootConfig
    from seedlink_dashboard.core.config_store import ConfigStore
    from seedlink_dashboard.core.exceptions import ConfigError as _ConfigError  # noqa: F401
    from seedlink_dashboard.storage.gap_detector import GapEvent
...
class StreamingEngine(QObject):
    ...
    def _version_string() -> str:
        ...
        try:
            return str(version("seedlink-dashboard"))
