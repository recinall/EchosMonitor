...
class AppConfig(_Base):
    ...
    # ``platformdirs.user_data_dir("seedlink_dashboard","SeedTiLa")/archive``.
...
class HvsrConfig(_Base):
    ...
    The config mirror of :class:`~seedlink_dashboard.core.hvsr.HvsrSettings`
...
class RootConfig(_Base):
    ...
    def _devices_map_to_distinct_archive_dirs(self) -> RootConfig:
        ...
        :func:`~seedlink_dashboard.storage.sds.sanitize_device_name` is not
        ...
        """
        from seedlink_dashboard.storage.sds import sanitize_device_name
