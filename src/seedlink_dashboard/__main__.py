...
from seedlink_dashboard.config import load_config
from seedlink_dashboard.config.loader import user_config_path
from seedlink_dashboard.core.firstrun import is_first_run
from seedlink_dashboard.gui.dialogs.first_run_wizard import FirstRunWizard
from seedlink_dashboard.gui.main_window import MainWindow
from seedlink_dashboard.utils.logging import configure_logging
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="seedlink-dashboard",
        description="Realtime SeedLink seismic monitoring dashboard.",
    )
    parser.add_argument(
        "--config",
        type=Path,
