...
The widget beside the PSD tab. It drives an :class:`~echosmonitor.
...
:class:`~echosmonitor.core.hvsr.HvsrResult` the engine emits (the
...
class HvsrWidget(QWidget):
    ...
    def _report_context(self) -> object:
        from echosmonitor.storage.hvsr_report import ReportContext
    ...
    def _on_save_report(self) -> None:
        ...
        from echosmonitor.storage.hvsr_report import HvsrExportError, write_hvsr_pdf
