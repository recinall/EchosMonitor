...
:class:`HvsrEngine` is a *peer* of :class:`~echosmonitor.core.
...
:mod:`echosmonitor.core.hvsr`; the engine only ever sees the frozen
:class:`~echosmonitor.core.hvsr.HvsrResult`.
"""
