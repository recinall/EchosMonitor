...
from echosmonitor.core.models import ConnState, WorkerDiagnostics

if TYPE_CHECKING:
    from obspy.core.trace import Trace

    from echosmonitor.config import ReconnectConfig
    from echosmonitor.core.models import FailureKind, StreamSelector
...
class SeedLinkWorker(QObject):
    ...
    def __init__(
        ...
        if reconnect is None:
            from echosmonitor.config.schema import ReconnectConfig as _ReconnectConfig
