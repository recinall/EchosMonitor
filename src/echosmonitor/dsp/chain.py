...
from echosmonitor.dsp.stages import Decimation, Stage, StaLta

if TYPE_CHECKING:
    from obspy.core.utcdatetime import UTCDateTime

    from echosmonitor.core.models import StreamID, Trigger
...
class DspChain:
    ...
    Constructed by :func:`echosmonitor.dsp.factory.build_chain`. The
